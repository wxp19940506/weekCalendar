...
//        int weekDay = SpecialCalendarutil.getWeekDay(data);
        //mTvYearMouth.setText(String.format("%s/%s/%s", String.valueOf(data.year), String.valueOf(data.month),String.valueOf(data.day))+"-"+String.format("%s/%s/%s", String.valueOf(data.year), String.valueOf(data.month),String.valueOf(data.day)));
    }
    ...
    private void initView() {
        ...
        List list = weeks.get(weekPosition);
        getThisWeekFirstAndEnd(list);
        mGridView.setAdapter(new CalendarAdapter(context,list));
    ...
    private GridView addDayView() {
        ...
        gridView.setBackgroundColor(getResources().getColor(R.color.back));
...
//    }
    ...
    public void showNextView(boolean isShowNextWeek) {
        ...
        CalendarAdapter adapter =  new CalendarAdapter(context,nextWeekDatas );
        ...
        getThisWeekFirstAndEnd(nextWeekDatas);
    }
    ...
    public void showLastView(boolean isShowLastWeek) {
        ...
        CalendarAdapter adapter =  new CalendarAdapter(context,lastWeekDatas );
        mGridView.setAdapter(adapter);
        mRvDay.addView(mGridView, 1);
        ...
        mRvDay.showNext();
        mRvDay.removeViewAt(0);
        getThisWeekFirstAndEnd(lastWeekDatas);
    }
    ...
    //获取本周第一天和最后一天
    public void getThisWeekFirstAndEnd(List<CalendarData> weekDatas){
        CalendarData calendar0 = weekDatas.get(0);
        CalendarData calendar1 = weekDatas.get(6);
        mTvYearMouth.setText(calendar0.year+"/"+calendar0.month+"/"+calendar0.day+"-"+calendar1.year+"/"+calendar1.month+"/"+calendar1.day);
    }
