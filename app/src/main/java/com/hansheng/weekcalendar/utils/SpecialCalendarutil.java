package com.hansheng.weekcalendar.utils;
...
public class SpecialCalendarutil {
    ...
    public static Map<Integer, String> getWeekString( Context mContext) {
        ...
        map.put(0, mContext.getString(R.string.Monday));
        map.put(1, mContext.getString(R.string.Tuesday));
        map.put(2, mContext.getString(R.string.Wednesday));
        map.put(3, mContext.getString(R.string.Thursday));
        map.put(4, mContext.getString(R.string.Friday));
        map.put(5, mContext.getString(R.string.Saturday));
        map.put(6, mContext.getString(R.string.Sunday));
        return map;
    }
    ...
    public static List<CalendarData> getWholeMonthDay(CalendarData day) {
        ...
        //添加上个月几天
        for (int i = 0; i < weekdayOfFirstDayInMonth - 1; i++) {
        ...
        //添加下个月的几天
        for (int i = 0; i < 5 - weekdayOfLastDayInMonth; i++) {
